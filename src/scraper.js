...
const BASE_SEARCH_URL = 'https://9gag.com/v1/search-posts?query=';
...
class Scraper {
  ...
  constructor(postCount, section = 'hot', query,commentCount = 0, httpClient = new HttpClient()) {
  ...
  postsUrl(lastPostId) {
    let url = BASE_SEARCH_URL + encodeURI(this.section);
